...
if __name__ == "__main__":
    ...
    print(result_summary_rando_first.items())
    ...
    print(result_summary_minimax_first.items())
    ...
    with open(log_file_path, "a") as file:
        ...
        file.write("random first: " + str({k: v for k, v in result_summary_rando_first.items()}) + "\n" + "minimax first: " + str({k: v for k, v in result_summary_minimax_first.items()}) + "\n")